...
const Quiz: React.FC = () => {
  const data = [
    ...
    {
      question:
        "Which of the following is a core concept of OOP that helps in reusability of code?",
    ...
    },
    {
      ...
      options: [
        ...
        "To group related code and data together",
    ...
    {
      question:
        "Which OOP concept is used to achieve runtime polymorphism in Java?",
  ...
  const showAns = () => {
    return (
      <>
        <div>
          Your score is : {ansCount} out of : {data.length}
        </div>
